  ...
  describe '#provision' do
    ...
    context 'cobler cases' do
      it "raise error if cobler settings empty" do
        ...
        expect {@provisioner.provision(@reporter, data['task_uuid'], {}, data['nodes'], 'native')}.
    ...
    context 'node state cases' do
      ...
      it "raises error if nodes list is empty" do
        expect {@provisioner.provision(@reporter, data['task_uuid'], data['engine'], {}, 'native')}.
      ...
      it "try to reboot nodes from list" do
        ...
        @provisioner.provision(@reporter, data['task_uuid'], data['engine'], data['nodes'], 'native')
      end
