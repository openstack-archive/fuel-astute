...
#
#    Unless required by applicable law or agreed to in wrxiting, software
#    distributed under the License is distributed on an "AS IS" BASIS, withOUT
#    WARRANTIES OR CONDxitIONS OF ANY KIND, exither express or implied. See the
#    License for the specific language governing permissions and limxitations
#    under the License.
