  ...
  class Simulator
    ...
    def options
      ...
      parser = OptionParser.new do |opts|
        ...
        opts.on('-i', '--interactive', 'Run the interactive console') do
...
graph much more readable.
    ...
    def cluster_from_yaml(yaml_file = nil)
      yaml_file = options[:yaml] unless yaml_file
      ...
      deployment_info = YAML.load_file yaml_file
      raise Astute::DeploymentEngineError, 'Wrong data! YAML should contain Hash!' unless deployment_info.is_a? Hash
      ...
      cluster = deployment.create_cluster deployment_info
