...
module Astute
  class Simulator < TaskDeployment
    ...
    def cluster(tasks_graph: {}, deployment_info: [])
    ...
    def options
      ...
      OptionParser.new do |opts|
        ...
        opts.on('-f', '--fail=task1/node1,task2/node2', Array) do |value|
    ...
    def from_tasks_yaml(tasks_yaml_file)
      raise Astute::DeploymentEngineError, "File: #{tasks_yaml_file} doesn't exist!" unless File.file? tasks_yaml_file
