...
require 'astute/pre_deploy_actions/pre_patching'
require 'astute/pre_deploy_actions/pre_patching_ha'
...
require 'astute/post_deploy_node_actions/post_patching_ha'
require 'astute/ssh'
