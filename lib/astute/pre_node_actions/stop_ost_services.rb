...
module Astute
  class StopOSTServices < PreNodeAction
    ...
    def process(deployment_info, context)
      ...
      file_content = File.read File.join(File.dirname(__FILE__), 'stop_services.script')
      target_file = upload_script(context, node_uids, file_content)
    ...
    def upload_script(context, node_uids, file_content)
