  ...
  class Provisioner
    ...
    def provision(reporter, task_id, engine_attrs, nodes)
      ...
      begin
        ...
        failed_nodes, timeouted_nodes = provision_and_watch_progress(reporter, task_id, Array.new(nodes), engine_attrs, max_prc_to_fail)
    ...
    def provision_and_watch_progress(reporter, task_id, nodes_to_provision, engine_attrs, max_prc_to_fail)
        ...
        loop do
          sleep_not_greater_than(20) do
            ...
            if nodes_not_booted.count < max_nodes && nodes_to_provision.count > 0
              ...
              Astute.logger.info "Nodes to reboot: #{new_nodes} "
