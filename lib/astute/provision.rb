  ...
  class Provisioner
    ...
    def provision(reporter, task_id, engine_attrs, nodes)
      ...
      begin
        ...
        failed_nodes, timeouted_nodes = provision_and_watch_progress(reporter, task_id, Array.new(nodes),
                                                                     engine_attrs, max_nodes_to_fail)
    ...
    def provision_and_watch_progress(reporter, task_id, nodes_to_provision, engine_attrs, max_nodes_to_fail)
