  ...
  class Provisioner
    ...
    def provision(reporter, task_id, provisioning_info, provision_method)
      ...
      begin
        ...
        bootstrap_profile = Astute.config[:bootstrap_profile]
        cobbler.edit_nodes(existent_nodes, {'profile' => bootstrap_profile})
    ...
    def provision_piece(reporter, task_id, engine_attrs, nodes, provision_method)
      ...
      if provision_method == 'image'
        ...
        cobbler.edit_nodes(nodes, {'profile' => bootstrap_profile})
